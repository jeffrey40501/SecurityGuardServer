...
public class AccountSvc{
	...
	static{
		...
		charPricesMap.put(102, 15);
		charPricesMap.put(103, 10);
	}
	...
	static{
		...
		charlist.add(new Character("測試3",102, 15, "http://i.imgur.com/wFfq4Xm.png", "127.0.0.1", "10003"));
		charlist.add(new Character("測試4",103, 10, "http://i.imgur.com/wwFDtp4.png", "127.0.0.1", "10004"));
